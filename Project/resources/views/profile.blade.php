                            ...
                            <li>
                                <div class="p-4 border border-gray-200 rounded-md">
                                    <div class="flex items-center gap-5 mb-5">
                                        <div class="w-1/3">
                                            <img src="{{ asset('/img/bmw-1024x768.jpg') }}" alt=""
                                        ...
                                        <div class="break-words w-2/3">
                                            ...
                                            <p class="font-medium text-black/70 mb-1">
                                                Адрес доставки: г. Иркутск, ул. Ленина, 5а
                                            </p>
                                            <p class="font-medium text-black/70">
                                                Дата доставки: 30.12.2024
                                            </p>
                                        </div>
                                    </div>
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-4 md:p-5 space-y-4">
                                                    <form class="flex flex-col">
                                                        ...
                                                        <textarea class="w-full h-24 focus:!ring-purple-700 focus:!ring-2 focus:border-purple-700 rounded-md mb-5"></textarea>
                                                        <button type="submit"
